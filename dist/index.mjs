...
function create_fragment(ctx) {
	...
	const switch_instance_spread_levels = [
		{ send: /*sendEvent*/ ctx[5] },
		{ router: /*sharedData*/ ctx[4] },
		/*props*/ ctx[0]
	];
	...
	return {
		...
		p(ctx, [dirty]) {
			const switch_instance_changes = (dirty & /*sendEvent, sharedData, props*/ 49)
			? get_spread_update(switch_instance_spread_levels, [
					dirty & /*sendEvent*/ 32 && { send: /*sendEvent*/ ctx[5] },
					dirty & /*sharedData*/ 16 && { router: /*sharedData*/ ctx[4] },
...
function instance($$self, $$props, $$invalidate) {
	...
	component_subscribe($$self, currentName, value => $$invalidate(12, $currentName = value));
	const lastEvent = writable({});
	component_subscribe($$self, lastEvent, value => $$invalidate(11, $lastEvent = value));
	...
	const sharedData = derived([currentName, lastEvent], ([_currentName, { name, data, _event }], set) => set({
		data,
		_event,
		event: name,
	...
	const sendEvent = (name = "", data = {}) => {
		...
		set_store_value(lastEvent, $lastEvent = { _event, data, name });
		sanitize(name);
